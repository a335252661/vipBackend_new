...
public class JdbcUtil {
	 ...
	 * @throws SQLException
	 */
	public static Long getSeqNextVal(Connection dbConn, String seqName) throws JdbcException {
		String sql = "select "+seqName+".nextval from dual";

		return new Long(queryForString(dbConn,sql));
	}
	
	public static List queryForList(Connection dbConn, String sql) throws JdbcException {
		...
		try{
			...
			se.printStackTrace();
			throw new JdbcException("操作数据库时出错! sql = " + sql);
		} finally {
			close(rs);
			close(state);
		}
	...
	public static String queryForString(Connection dbConn, String sql) throws JdbcException {
		Statement state = null;
		ResultSet rs = null;
		String val = null;
		try{
	...
	public static boolean isExist(Connection dbConn, String sql) throws JdbcException {
		Statement state = null;
		ResultSet rs = null;
		boolean flag = false;
		try{
