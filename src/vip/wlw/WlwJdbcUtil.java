...
//	}
	 ...
	 * @throws SQLException
	 */
	public static Long getSeqNextVal(Connection dbConn, String seqName) throws Exception {
		String sql = "select "+seqName+".nextval from dual";

		return new Long(queryForString(dbConn,sql));
	}
	 ...
	 * @throws SQLException
	 */
	public static Long getMysqlSeqNextVal(Connection dbConn, String seqName) throws Exception {
		String sql = "select "+seqName+".nextval ";

		return new Long(queryForString(dbConn,sql));
	}
	
	public static List queryForList(Connection dbConn, String sql) throws Exception {
		...
		try{
			...
			list = (ArrayList)getMaps(rs);
		}catch (Exception se){
			throw new Exception("操作数据库时出错! sql = " + sql);
		} finally {
			close(rs);
			close(state);
		}
	...
	public static List<String> queryServCodeList(Connection dbConn, String sql) throws Exception {
		Statement state = null;
		ResultSet rs = null;
	...
	public static String queryForString(Connection dbConn, String sql) throws Exception {
		Statement state = null;
		ResultSet rs = null;
		String val = null;
		try{
	...
	public static boolean isExist(Connection dbConn, String sql) throws Exception {
		Statement state = null;
		ResultSet rs = null;
		boolean flag = false;
		try{
	...
	public static void close(Statement stat){
		if(null != stat){
			try {
				...
				XxlJobLogger.log("Statement close error : {} ",e.getMessage());
			}
		}
	}
	...
	public static void close(ResultSet rs){
		if(null != rs){
			try {
				...
				XxlJobLogger.log("ResultSet close error : {} ",e.getMessage());
			}
		}
	}
	...
	public static void close(Connection conn){
		if(null != conn){
			try {
				...
				XxlJobLogger.log("Connection close error : {} ",e.getMessage());
			}
		}
	}
}
