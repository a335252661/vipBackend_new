 ...
 * @date 2020/9/10
 */
public class CreateFileHelp3 extends Thread{
    ...
    private static CreateFileHelp3 shishouCreateFile= null;
    ...
    public static void main(String[] args) {
        ...
        try {
            shishouCreateFile = new CreateFileHelp3();
            ...
            while (true) {
                if (i == 0) {
                    ...
                    for(Integer ll :fast){
                        new Thread(shishouCreateFile,"T"+ll).run();
                    }
