 ...
 * @date 2019/11/18
 */
public class GetDataPay2 {


    //生产文件位置
    private static String dirLocation = "D:\\payment\\JtBill\\data\\WLW\\手动0720\\";
...
//    private static String dirLocation = "/home/bgusr01/vip_backend/2.1new/";
    ...
    //文件个数
    private static int fileTol = 901;
    ...
    public static void main(String[] args) {
        ...
        GetDataPay2 getData = new GetDataPay2();
...
//            iamConn = DBConn.getDbusr06ProConn();
            ...
            //判断批次
            String fileName = "BILL2IOT.PARTPAY." + sys_datetime ;
            ...
            TxtWriterHelp.createFile(dirLocation,"BILL2IOT.SUM."+sys_datetime+".901.021",
                    "");
...
//        String ID = rstInst.getString("ID");
        ...
        String EXPENSES_ID = rstInst.getString("EXPENSES_ID");

        String xzNum2 = this.getXZNum2();
        ...
        String s =id + "|" + ACCT_ID + "|" + "-1" + "|" + SERV + "|" +
                ...
                POSTDATE + "|" + STATU + "|" + EXPENSES_ID + "|" +xzNum2 + "|";
    ...
    public ResultSet getData() throws Exception {
        String sql = "select * from cld_pay3 ";
        PreparedStatement pstmtInst = iamConn.prepareStatement(sql);
        ResultSet rstInst = pstmtInst.executeQuery();

        ArrayList<String> strings = SQLHelp.querySQLReturnList2(iamConn, "select count(1) , sum(amount) from cld_pay3");
